...
total_epochs = 12
checkpoint_config = dict(interval=12)    # interval表示每多少个epoch，save checkpoints
evaluation = dict(interval=1, metrics=['top_k_accuracy', 'mean_class_accuracy'], topk=(1, 5))
log_config = dict(interval=20, hooks=[dict(type='TextLoggerHook')])
log_level = 'INFO'
work_dir = './work_dirs/actionclip/slowonly_r50_trans_hmdb51_nopretrain/s1_joint_e3_d0_r1'
