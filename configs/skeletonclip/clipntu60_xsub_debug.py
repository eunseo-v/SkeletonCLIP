model = dict(
    ...
    class_list = '/home/yl/pyskl/lists/ntu_60_labels.csv',
)
...
# optimizer
optimizer = dict(
    type='AdamW', lr=0.4, weight_decay=0.0003,
    paramwise_cfg = dict(
        custom_keys = {
            'backbone.text_encoder': dict(lr_mult=0.0001, decay_mult=0.9), # 4e-5
            'cls_head': dict(lr_mult=0.001, decay_mult=0.9) # 4e-4
        }
    )
...
log_level = 'INFO'
work_dir = './work_dirs/actionclip/ntu60_xsub/mydebug'
